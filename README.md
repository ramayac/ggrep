...
I decided to make my own grep with Java, nothing fancy, keep it simple and useful (do one thing and do it right), here it is in all his unasuming glory JGrep: https://gist.github.com/ramayac/8926162. I used gist to track the small change I made to it. This little piece of code save me a lot of time back then.

Then in 2017, when I started working at Big Canada Telco, I landed into a tiny 3 person team, lots of code, lots of meetings and also lots of support!!!
...
Well, well, well, lightning *can* strike twice.

I open the gist, build the little .jar and it works like magic.
The little .jar file really saved us alot of time. 
Support dropped from days of downloading files and searching logs to just executing a command and waiting2 to 5 min at worst (ftp server had great performance) to get the results.

My coworker was happy, I was happy, and my BSA did not belive we could do it that fast. Good times!

(And no, I never tried if Perl was available, so don't ask)
